...
plot_individual2 <- all.data %>%
 # filter(NonsocialRoom3=="Low")%>%
  ...
  summarize(tool_transfer = mean(tool_trans))  %>%
  mutate(tool_transfer = round(tool_transfer/0.02)*0.02)%>%
  add_count(tool_transfer)
...
p2<-ggplot(
  ...
  geom_boxplot(aes(group=SpaghettiTube), width=0.5)+
  geom_point(size = plot_individual2$n, colour = "blue") +
  geom_line(lty=2)+
  ylim(0,1)+
...
p1 <- ggplot(
  ...
  geom_boxplot(aes(group=NonsocialRoom3), width=0.5)+
  geom_point(size = plot_individual3$n, colour = "blue") +
  geom_line(lty=2)+
  ylim(0,1)+
...
p3 <- ggplot(
  ...
  geom_boxplot(aes(group=Presence), width=0.5)+
  geom_point(size = plot_individual4$n, colour = "blue") +
  geom_line(lty=2)+
  ylim(0,1)+
...
median_gesture<-plot_individual5  %>%
  group_by(Gesture) %>% 
  summarize(tool_transfer2 = median(tool_transfer))  

p4<-ggplot(
  data=plot_individual5, aes(Gesture, tool_transfer, group=dir_dyad)) +   
  geom_boxplot(aes(group=Gesture), width=0.5)+
  geom_line(lty=2)+
  geom_point(size = plot_individual5$n, colour = "blue") +
  ylim(0,0.8)+
